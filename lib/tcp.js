...
freedomTCP.prototype.writeUtf8String = function(req, s) {
  ...
  if (s == '<starttls xmlns="urn:ietf:params:xml:ns:xmpp-tls"/>') {
    // TODO: this is a hack to work around issues with secure sockets in Chrome:
